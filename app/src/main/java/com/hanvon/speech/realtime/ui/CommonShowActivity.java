...
public class CommonShowActivity extends BaseActivity {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.purchase:
                ...
                RetrofitManager.getInstance(this).createOrderByPack(map, new RetrofitManager.ICallBack() {
                    @Override
                    public void successData(String result) {
                        ...
                        if (TextUtils.equals(c.getCode(), Constant.SUCCESSCODE)) {
                            ...
                            RetrofitManager.getInstance(CommonShowActivity.this).PayOrderByWxNative(map, new RetrofitManager.ICallBack() {
                                @Override
                                public void successData(String result) {
                                    Gson gson2 = new Gson();
                                    ...
                                    if (TextUtils.equals(c.getCode(), Constant.SUCCESSCODE)) {
                                        ...
                                        findViewById(R.id.qr_code_txt).setVisibility(View.VISIBLE);
    ...
    private void checkPayStatus(String id) {
        RetrofitManager.getInstance(this).getOrder(id, new RetrofitManager.ICallBack() {
            @Override
            public void successData(String result) {
                Gson gson2 = new Gson();
                OrderDetail c = gson2.fromJson(result, OrderDetail.class);
