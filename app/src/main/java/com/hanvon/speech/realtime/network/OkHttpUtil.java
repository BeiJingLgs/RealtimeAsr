package com.hanvon.speech.realtime.network;
...
public class OkHttpUtil {
     ...
     * @return
     */
    public Response doPost(String url, Map<String, String> bodyParams) {
        //1构造RequestBody
     ...
     * @return
     */
    public void doGetAsyn(String url, final NetCall netCall) {
        //1 构造Request
        Request.Builder builder = new Request.Builder();
        Request request = builder.get().url(url).build();
        //2 将Request封装为Call
     ...
     * @param netCall
     */
    public void doPostAsyn(String url, Map<String, String> bodyParams, final NetCall netCall) {
        //1构造RequestBody
        RequestBody body = setRequestBody(bodyParams);
        //2 构造Request
        Request.Builder requestBuilder = new Request.Builder();
