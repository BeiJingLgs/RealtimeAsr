...
public class Result implements Serializable {
    ...
    public Result(int errNo, String errMsg, String type, String result, long startTime, long endTime, String sn, long logId, String orignalJsonStr, long receiveTime) {
        this.errNo = errNo;
        this.errMsg = errMsg;
        this.type = type;
        this.result = result;
        ...
        this.sn = sn;
        this.logId = logId;
        this.orignalJsonStr = orignalJsonStr;
