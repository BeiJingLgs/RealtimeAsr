...
public abstract class AbstractUIActivity extends AppCompatActivity {
    ...
    protected TextView txtLog, mTxtResult;
    ...
    private void initUi() {
        ...
        /*LocalBroadcastManager.getInstance(this)
                .registerReceiver(localReceiver, new IntentFilter("updateText"));*/
    ...
    public class LocalReceiver extends BroadcastReceiver {
        public void onReceive(Context context, Intent intent) {
           // String str = intent.getStringExtra("convert");
          //  mTxtResult.setText(mTxtResult.getText().toString() + str);
        }
    }
    /**
